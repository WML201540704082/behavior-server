...
public class JwtCrypto {
	...
	public static final String IDEVELOP_CRYPTO_AES_KEY = "idevelop.token.aes-key";
	 ...
	 */
	@Nullable
	public static char[] decryptToString(@Nullable String content, @Nullable String aesTextKey) {
		...
		bb.put(hexBytes).flip();
		CharBuffer charBuffer = cs.decode(bb);
