 ...
 * @since 2024-03-19
 */
public interface DeviceRepairListMapper extends BaseMapper<DeviceRepairList> {
	 ...
	 * @return
	 */
	List<DeviceRepairListVO> selectDeviceRepairListPage(IPage page, DeviceRepairListVO deviceRepairList);
