 ...
 */
@Data
public class HardwareBasicCmdbDeviceFZSBDTO extends HardwareBasicCmdbDeviceDTO {
	...
	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 14, value = "所在仓库")
	private String inWarehouse;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelCorpSelected
	@ExcelProperty(index = 15, value = "领用单位")
	private String receiveUnit;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelDeptSelected
	@ExcelProperty(index = 16, value = "领用部门")
	...
	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 25, value = "责任人ISC账号")
	...
	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 28, value = "所属机房")
	private String computerRoom;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 29, value = "安装地点")
	private String installationSite;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelSelected(ciId = "power-level", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 30, value = "电压等级")
	private String voltageLevel;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 31, value = "PDU额定功率(W)")
	private String pduRatedPower;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 32, value = "PDU运行功率(W)")
	private String pduOperatePower;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 33, value = "机柜容量(U)")
	private String cabinetCapacity;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 34, value = "布线节点数(个)")
	private String wiringNodeNo;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 35, value = "电源负载(VA)")
	private String powerLoad;

	@HeadFontStyle(color = 8, bold = false)
	@ExcelProperty(index = 36, value = "备注")
	private String remark;

	@HeadFontStyle(color = 0, bold = false)
	@ExcelDeptSelected
	@ExcelProperty(index = 37, value = "产权部门")
	private String propertyDept;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelSelected(ciId = "data-opt", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 38, value = "操作类型")
	private String dataOptType;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 39, value = "设备编码")
	private String deviceCode;

	@HeadFontStyle(color = 8, bold = false)
	@ExcelProperty(index = 40, value = "id")
	private String id;
