 ...
 */
@Data
public class HardwareBasicCmdbDeviceErrorZJSBDTO extends HardwareBasicCmdbDeviceDTO {
	...
	@HeadFontStyle(color = 53, bold = false)
	@ExcelCorpSelected
	@ExcelProperty(index = 14, value = "领用单位")
	private String receiveUnit;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelDeptSelected
	@ExcelProperty(index = 15, value = "领用部门")
	private String receiveDept;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelSelected(ciId = "device-add-type", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 16, value = "设备增加方式")
	...
	@ExcelProperty(index = 17, value = "采购日期")
	...
	@ExcelValidDate(message = CommonConstant.DATE_FORMAT)
	@DateTimeFormat(CommonConstant.DATE_FORMAT)
	@ExcelProperty(index = 19, value = "首次投运日期")
	private String oprtDateFirst;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelValidDate(message = CommonConstant.DATE_FORMAT)
	@DateTimeFormat(CommonConstant.DATE_FORMAT)
	@ExcelProperty(index = 20, value = "投运日期")
	...
	@ExcelValidDate(message = CommonConstant.DATE_FORMAT)
	@DateTimeFormat(CommonConstant.DATE_FORMAT)
	@ExcelProperty(index = 21, value = "服务到期时间")
	private String serviceExpDate;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelValidDate(message = CommonConstant.DATE_FORMAT)
	@DateTimeFormat(CommonConstant.DATE_FORMAT)
	@ExcelProperty(index = 22, value = "退运日期")
	private String retireDate;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelValidDate(message = CommonConstant.DATE_FORMAT)
	@DateTimeFormat(CommonConstant.DATE_FORMAT)
	@ExcelProperty(index = 23, value = "报废日期")
	private String scrapDate;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 24, value = "所在仓库")
	private String inWarehouse;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 25, value = "责任人")
	private String receivingPerson;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 26, value = "责任人统一权限账号")
	private String receivePersonUnifiedAcc;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 27, value = "责任人联系方式")
	private String receivingTel;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 28, value = "责任人身份证")
	private String receivingIDCard;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelSelected(ciId = "net-work-code", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 29, value = "所属网络")
	private String netWork;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 30, value = "IP地址")
	private String IP;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 31, value = "MAC地址")
	private String MAC;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 32, value = "安装地点")
	private String installationSite;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 33, value = "操作系统位数(位)")
	private String OSBits;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 34, value = "操作系统版本")
	private String OSVersion;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 35, value = "所属机房")
	private String computerRoom;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 36, value = "机柜")
	private String cabinet;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 37, value = "设备起始高度(U)")
	private String deviceHeightBegin;

	@HeadFontStyle(color = 10, bold = false)
	@ExcelValid(required = true)
	@ExcelValidNumber
	@ExcelProperty(index = 38, value = "设备高度(U)")
	private String deviceHeight;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelSelected(ciId = "server-use-to-type", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 39, value = "主机设备用途类型")
	private String serverUseToType;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelSelected(ciId = "security-boundary", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 40, value = "所属安全边界")
	private String securityBoundary;

	@HeadFontStyle(color = 8, bold = false)
	@ExcelProperty(index = 41, value = "硬盘容量(GB)")
	private Double hardDiskCapability;

	@HeadFontStyle(color = 8, bold = false)
	@ExcelProperty(index = 42, value = "CPU核数(核)")
	private Double cpuCoreSize;

	@HeadFontStyle(color = 8, bold = false)
	@ExcelSelected(ciId = "cpu-arch-code", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 43, value = "CPU架构")
	private String cpuArch;

	@HeadFontStyle(color = 8, bold = false)
	@ExcelSelected(ciId = "cpu-brand", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 44, value = "CPU品牌")
	private String cpuBrand;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 45, value = "操作系统版本号")
	private String systemVersion;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelSelected(ciId = "OSType-code", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 46, value = "操作系统类型")
	private String OSType;

	@HeadFontStyle(color = 8, bold = false)
	@ExcelProperty(index = 47, value = "内存大小(GB)")
	private Double memSize;

	@HeadFontStyle(color = 8, bold = false)
	@ExcelProperty(index = 48, value = "备注")
	private String remark;

	@HeadFontStyle(color = 0, bold = false)
	@ExcelDeptSelected
	@ExcelProperty(index = 49, value = "产权部门")
	private String propertyDept;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelSelected(ciId = "cloud-type", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 50, value = "云类型")
	private String cloudType;

	@HeadFontStyle(color = 8, bold = false)
	@ExcelSelected(ciId = "data-opt", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 51, value = "操作类型")
	private String dataOptType;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 52, value = "设备编码")
	private String deviceCode;

	@HeadFontStyle(color = 8, bold = false)
	@ExcelProperty(index = 53, value = "id")
	private String id;
