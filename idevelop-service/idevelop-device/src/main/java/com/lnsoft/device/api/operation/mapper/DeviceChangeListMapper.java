 ...
 * @since 2024-03-07
 */
public interface DeviceChangeListMapper extends BaseMapper<DeviceChangeList> {
	 ...
	 * @return
	 */
	List<DeviceChangeListVO> selectDeviceChangeListPage(IPage page, DeviceChangeListVO deviceChangeList);
	/**
	 * 根据changeId删除
	 *
	 * @param changeId
	 * @return
	 */
    int deleteByChangeId(String changeId);
	/**
	 * 根据changeId
	 * @param deviceCode
	 * @return
