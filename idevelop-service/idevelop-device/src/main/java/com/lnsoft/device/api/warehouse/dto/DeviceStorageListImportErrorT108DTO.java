...
@Data
@NoArgsConstructor
public class DeviceStorageListImportErrorT108DTO implements Serializable {
	...
	@ExcelProperty(index = 1, value = "出厂序列号(必填)")
	private String sn;
	...
	@ExcelProperty(index = 17, value = "制造商(必填)")
	private String maker;

	@ExcelValid(required = true)
	@ExcelProperty(index = 18, value = "标准全称(必填)")
