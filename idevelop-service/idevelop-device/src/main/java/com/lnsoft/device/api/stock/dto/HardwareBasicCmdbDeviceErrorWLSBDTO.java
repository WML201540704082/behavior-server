 ...
 */
@Data
public class HardwareBasicCmdbDeviceErrorWLSBDTO extends HardwareBasicCmdbDeviceDTO {
	...
	@ExcelProperty(index = 14, value = "设备增加方式")
	...
	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 27, value = "责任人身份证")
	...
	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 31, value = "所在仓库")
	...
	@HeadFontStyle(color = 53, bold = false)
	@ExcelSelected(ciId = "network-device-type", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 33, value = "网络设备用途类型")
	private String networkDeviceType;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 34, value = "所属机房")
	private String computerRoom;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 35, value = "机柜")
	private String cabinet;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 36, value = "设备起始高度(U)")
	private String deviceHeightBegin;

	@HeadFontStyle(color = 10, bold = false)
	@ExcelValid(required = true)
	@ExcelProperty(index = 37, value = "设备高度")
	private String deviceHeight;

	@HeadFontStyle(color = 10, bold = false)
	@ExcelValid(required = true)
	@ExcelSelected(ciId = "standby-attr", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 38, value = "主备属性")
	private String standbyAttr;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelSelected(ciId = "security-boundary", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 39, value = "所属安全边界")
	...
	@ExcelDeptSelected
	@ExcelProperty(index = 41, value = "产权部门")
	private String propertyDept;

	@HeadFontStyle(color = 8, bold = false)
	@ExcelSelected(ciId = "data-opt", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 42, value = "操作类型")
	private String dataOptType;

	@HeadFontStyle(color = 8, bold = false)
	@ExcelProperty(index = 43, value = "设备编码")
	private String deviceCode;

	@HeadFontStyle(color = 8, bold = false)
	@ExcelProperty(index = 44, value = "id")
	private String id;
}
