...
public interface DeviceScrapMapper extends BaseMapper<DeviceScrap> {
	 ...
	 * @return
	 */
	List<DeviceScrapVO> selectDeviceScrapPage(IPage page, DeviceScrapVO deviceScrap);
	 ...
	 * @return
	 */
	IPage<DeviceScrapVO> deskDeviceScrapList(DeviceScrapDTO dto, IPage<DeviceScrap> page);

    IPage<DeviceScrap> getPage(IPage<DeviceScrap> page, DeviceScrapDTO dto);
}
