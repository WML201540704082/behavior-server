...
@Data
@NoArgsConstructor
public class DeviceStorageListImportT101DTO implements Serializable {
	...
	@ExcelValid(required = true)
	@ExcelValidNumber
	@ExcelProperty(index = 10, value = "CPU核数(核)")
	...
	@ExcelProperty(index = 12, value = "CPU品牌(必填)")
	private String cpuBrand;


	@ExcelValid(required = true)
	@ExcelValidNumber
	@ExcelProperty(index = 13, value = "内存大小(GB)")
