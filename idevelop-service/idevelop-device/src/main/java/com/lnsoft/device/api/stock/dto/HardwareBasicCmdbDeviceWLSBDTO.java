 ...
 */
@Data
public class HardwareBasicCmdbDeviceWLSBDTO extends HardwareBasicCmdbDeviceDTO {
	...
	@ExcelProperty(index = 13, value = "设备增加方式")
	...
	@HeadFontStyle(color = 53, bold = false)
	@ExcelCorpSelected
	@ExcelProperty(index = 21, value = "领用单位")
	private String receiveUnit;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelDeptSelected
	@ExcelProperty(index = 22, value = "领用部门")
	private String receiveDept;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 23, value = "责任人")
	private String receivingPerson;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 24, value = "责任人统一权限账号")
	private String receivePersonUnifiedAcc;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 25, value = "责任人联系方式")
	private String receivingTel;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 26, value = "责任人身份证")
	private String receivingIDCard;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelSelected(ciId = "net-work-code", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 27, value = "所属网络")
	private String netWork;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 28, value = "IP地址")
	private String IP;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 29, value = "MAC地址")
	private String MAC;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 30, value = "所在仓库")
	...
	@ExcelProperty(index = 32, value = "网络设备用途类型")
