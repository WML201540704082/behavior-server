 ...
 */
@Data
public class HardwareBasicCmdbDeviceErrorCCSBDTO extends HardwareBasicCmdbDeviceDTO {
	...
	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 28, value = "责任人身份证号")
	...
	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 32, value = "所属机房")
	private String computerRoom;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 33, value = "机柜")
	private String cabinet;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 34, value = "安装地点")
	private String installationSite;

	@HeadFontStyle(color = 10, bold = false)
	@ExcelValid(required = true)
	@ExcelValidNumber
	@ExcelProperty(index = 35, value = "存储容量(TB)")
	private String storageCapacity;

	@HeadFontStyle(color = 10, bold = false)
	@ExcelValid(required = true)
	@ExcelValidNumber
	@ExcelProperty(index = 36, value = "内存大小(GB)")
	private String memSize;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelSelected(ciId = "yes-no", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 37, value = "是否纳入云管")
	private String isCloudMange;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 38, value = "设备使用部门")
	private String deviceUseDept;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelValid(required = true)
	@ExcelProperty(index = 39, value = "电源模块(个)")
	@ExcelValidNumber
	private String powerModel;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 40, value = "额定功率(W)")
	@ExcelValidNumber
	private String ratedPower;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 41, value = "设备起始高度(U)")
	@ExcelValidNumber
