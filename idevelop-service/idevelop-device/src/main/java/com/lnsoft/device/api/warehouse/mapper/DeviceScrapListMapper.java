 ...
 */
@Repository
public interface DeviceScrapListMapper extends BaseMapper<DeviceScrapList> {
	 ...
	 * @return
	 */
	List<DeviceScrapListVO> selectDeviceScrapListPage(IPage page, DeviceScrapListVO deviceScrapList);
