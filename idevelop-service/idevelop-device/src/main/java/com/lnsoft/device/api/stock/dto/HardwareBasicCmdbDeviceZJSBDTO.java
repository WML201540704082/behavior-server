 ...
 */
@Data
public class HardwareBasicCmdbDeviceZJSBDTO extends HardwareBasicCmdbDeviceDTO {
	...
	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 31, value = "安装地点")
	private String installationSite;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 32, value = "操作系统位数(位)")
	private String OSBits;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 33, value = "操作系统版本")
