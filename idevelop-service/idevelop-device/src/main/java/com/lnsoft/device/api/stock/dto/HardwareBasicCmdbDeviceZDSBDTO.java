 ...
 */
@Data
public class HardwareBasicCmdbDeviceZDSBDTO extends HardwareBasicCmdbDeviceDTO {
	...
	@ExcelValidDate(message = CommonConstant.DATE_FORMAT)
	@DateTimeFormat(CommonConstant.DATE_FORMAT)
	@ExcelProperty(index = 28, value = "领用日期")
	private String receivingDate;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 29, value = "使用人")
	private String user;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 30, value = "使用人身份证")
	private String deviceUserIDCard;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelSelected(ciId = "net-work-code", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 31, value = "所属网络")
	private String netWork;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 32, value = "IP地址")
	private String IP;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 33, value = "MAC地址")
	private String MAC;
