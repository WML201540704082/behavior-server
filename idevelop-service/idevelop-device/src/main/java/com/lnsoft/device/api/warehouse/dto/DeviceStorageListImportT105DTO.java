...
@Data
@NoArgsConstructor
public class DeviceStorageListImportT105DTO implements Serializable {
	...
	@ExcelProperty(index = 1, value = "采购方式")
	private String procureType;

	@ExcelValid(required = true)
	@ExcelProperty(index = 2, value = "出厂序列号")
	private String sn;

	@ExcelValid(required = true)
	@ExcelSelected(ciId = "maker", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 3, value = "制造商")
	...
	@ExcelValid(required = true)
	@ExcelProperty(index = 7, value = "设备增加方式")
	...
	@ExcelProperty(index = 15, value = "是否信创设备")
