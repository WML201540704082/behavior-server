...
@Data
@NoArgsConstructor
public class DeviceStorageListImportT109XDCZDTO implements Serializable {
	...
	@ExcelValid(required = true)
	@ExcelProperty(index = 12, value = "电池数(块)")
	private Double batteryNum;

	@ExcelValid(required = true)
	@ExcelProperty(index = 13, value = "电池组数(组)")
	private Double batteryPackNum;

	@ExcelValid(required = true)
	@ExcelProperty(index = 14, value = "额定容量(A·h)")
	private String ratedCapacity;

	@ExcelValid(required = true)
	@ExcelProperty(index = 15, value = "所属UPS")
