...
@Data
@NoArgsConstructor
public class DeviceStorageListImportErrorT109XDCZDTO implements Serializable {
	...
	@ExcelProperty(index = 5, value = "制造商")
	...
	@ExcelProperty(index = 7, value = "系列")
	private String series;

	@ExcelValid(required = true)
	@ExcelSelected(ciId = "model", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 8, value = "型号")
	private String deviceModel;

	@ExcelCorpSelected
	@ExcelValid(required = true)
	@ExcelProperty(index = 9, value = "产权单位")
	private String ownerUnit;

	@ExcelDeptSelected
	@ExcelValid(required = true)
	@ExcelProperty(index = 10, value = "产权部门")
	private String propertyDept;

	@ExcelValid(required = true)
	@ExcelValidDate(message = CommonConstant.DATE_FORMAT)
	@DateTimeFormat(CommonConstant.DATE_FORMAT)
	@ExcelProperty(index = 11, value = "出厂日期")
	private String factoryDate;

	@ExcelValid(required = true)
	@ExcelValidDate(message = CommonConstant.DATE_FORMAT)
	@DateTimeFormat(CommonConstant.DATE_FORMAT)
	@ExcelProperty(index = 12, value = "服务到期日期")
	private String serviceExpDate;

	@ExcelValid(required = true)
	@ExcelProperty(index = 13, value = "电池数(块)")
	private Double batteryNum;

	@ExcelValid(required = true)
	@ExcelProperty(index = 14, value = "电池组数(组)")
	private Double batteryPackNum;

	@ExcelValid(required = true)
	@ExcelProperty(index = 15, value = "额定容量(A·h)")
	private String ratedCapacity;

	@ExcelValid(required = true)
	@ExcelProperty(index = 16, value = "所属UPS")
