...
@Data
@NoArgsConstructor
public class DeviceStorageListImportErrorT109KTDTO implements Serializable {
	...
	@ExcelProperty(index = 13, value = "空调类型")
	private String airConditionType;

	@ExcelValid(required = true)
	@ExcelProperty(index = 14, value = "匹数(匹)")
	private String horsepower;


	@ExcelValid(required = true)
	@ExcelProperty(index = 15, value = "制冷量(W)")
