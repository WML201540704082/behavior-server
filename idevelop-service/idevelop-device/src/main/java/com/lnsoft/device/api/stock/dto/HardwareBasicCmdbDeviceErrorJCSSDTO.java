 ...
 */
@Data
public class HardwareBasicCmdbDeviceErrorJCSSDTO extends HardwareBasicCmdbDeviceDTO {

	private static final long serialVersionUID = 1L;

	@HeadFontStyle(color = 8, bold = false)
	@ExcelProperty(index = 0, value = "异常信息(导入前,请删除此列)")
	@ColumnWidth(80)
	...
	@ExcelProperty(index = 2, value = "设备分类")
	private String deviceCategory;

	@HeadFontStyle(color = 10, bold = false)
	@ExcelValid(required = true)
	@ExcelSelected(ciId = "device-type", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 3, value = "设备类型")
	private String deviceType;

	@HeadFontStyle(color = 10, bold = false)
	@ExcelValid(required = true)
	@ExcelProperty(index = 4, value = "标准全称")
	...
	@ExcelProperty(index = 12, value = "系列")
	...
	@ExcelProperty(index = 15, value = "采购日期")
	...
	@ExcelValidDate(message = CommonConstant.DATE_FORMAT)
	@DateTimeFormat(CommonConstant.DATE_FORMAT)
	@ExcelProperty(index = 17, value = "首次投运日期")
	private String oprtDateFirst;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelValidDate(message = CommonConstant.DATE_FORMAT)
	@DateTimeFormat(CommonConstant.DATE_FORMAT)
	@ExcelProperty(index = 18, value = "投运日期")
	...
	@ExcelValidDate(message = CommonConstant.DATE_FORMAT)
	@DateTimeFormat(CommonConstant.DATE_FORMAT)
	@ExcelProperty(index = 19, value = "服务到期时间")
	private String serviceExpDate;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelValidDate(message = CommonConstant.DATE_FORMAT)
	@DateTimeFormat(CommonConstant.DATE_FORMAT)
	@ExcelProperty(index = 20, value = "退运日期")
	private String retireDate;

	@HeadFontStyle(color = 10, bold = false)
	@ExcelValidDate(message = CommonConstant.DATE_FORMAT)
	@DateTimeFormat(CommonConstant.DATE_FORMAT)
	@ExcelProperty(index = 21, value = "报废日期")
	private String scrapDate;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 22, value = "所在仓库")
	private String inWarehouse;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelCorpSelected
	@ExcelProperty(index = 23, value = "领用单位")
	private String receiveUnit;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelDeptSelected
	@ExcelProperty(index = 24, value = "领用部门")
	private String receiveDept;

	@HeadFontStyle(color = 13, bold = false)
	@ExcelProperty(index = 25, value = "运维单位")
	private String operationUnit;

	@HeadFontStyle(color = 13, bold = false)
	@ExcelProperty(index = 26, value = "运维部门")
	private String operationDept;

	@HeadFontStyle(color = 13, bold = false)
	@ExcelProperty(index = 27, value = "产权单位")
	private String ownerUnit;

	@HeadFontStyle(color = 13, bold = false)
	@ExcelProperty(index = 28, value = "维保情况")
	private String wbqk;

	@HeadFontStyle(color = 13, bold = false)
	@ExcelProperty(index = 29, value = "近三年故障情况")
	private String jsngzqk;

	@HeadFontStyle(color = 13, bold = false)
	@ExcelProperty(index = 30, value = "近三年故障次数")
	private String yzgzcs;

	@HeadFontStyle(color = 13, bold = false)
	@ExcelProperty(index = 31, value = "近三年隐患情况")
	private String jsnyhqk;

	@HeadFontStyle(color = 13, bold = false)
	@ExcelProperty(index = 32, value = "近三年隐患个数")
	private String yzyhgs;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 33, value = "责任人")
	private String receivingPerson;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 34, value = "责任人ISC账号")
	private String receivePersonUnifiedAcc;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 35, value = "责任人联系方式")
	private String receivingTel;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 36, value = "责任人身份证号")
	private String receivingIDCard;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 37, value = "所属机房")
	private String computerRoom;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 38, value = "安装地点")
	private String installationSite;

	@HeadFontStyle(color = 13, bold = false)
	@ExcelProperty(index = 39, value = "机房类型")
	private String jfjb;

	@HeadFontStyle(color = 13, bold = false)
	@ExcelProperty(index = 40, value = "机房功能")
	private String jfgn;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelSelected(ciId = "power-level", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 41, value = "电压等级")
	private String voltageLevel;

	@HeadFontStyle(color = 13, bold = false)
	@ExcelSelected(ciId = "yes-no", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 42, value = "是否需要更换")
	private String sfxygh;

	@HeadFontStyle(color = 13, bold = false)
	@ExcelSelected(ciId = "yes-no", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 43, value = "是否完成更换立项")
	private String sfwcghlx;

	@HeadFontStyle(color = 13, bold = false)
	@ExcelProperty(index = 44, value = "立项更换时间")
	private String lxghsj;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelDataReplace
	@ExcelSelected(ciId = "air-condition-type", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 45, value = "空调类型")
	private String airConditionType;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 46, value = "匹数(匹)")
	private String horsepower;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 47, value = "制冷量(W)")
	private Double coolCapacity;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 48, value = "UPS容量(KVA)")
	private String upsCapacity;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 49, value = "电源负载(VA)")
	private String powerLoad;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 50, value = "电池数(块)")
	private Double batteryNum;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 51, value = "电池组数(组)")
	private Double batteryPackNum;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 52, value = "额定容量(A·h)")
	private String ratedCapacity;

	@HeadFontStyle(color = 53, bold = false)
	@ExcelProperty(index = 53, value = "所属UPS")
	private String belongUps;

	@HeadFontStyle(color = 8, bold = false)
	@ExcelProperty(index = 54, value = "备注")
	private String remark;

	@HeadFontStyle(color = 0, bold = false)
	@ExcelDeptSelected
	@ExcelProperty(index = 55, value = "产权部门")
	private String propertyDept;

	@HeadFontStyle(color = 8, bold = false)
	@ExcelSelected(ciId = "data-opt", sourceClass = ExcelDynamicSelectImpl.class)
	@ExcelProperty(index = 56, value = "操作类型")
	private String dataOptType;

	@HeadFontStyle(color = 8, bold = false)
	@ExcelProperty(index = 57, value = "设备编码")
	private String deviceCode;

	@HeadFontStyle(color = 8, bold = false)
	@ExcelProperty(index = 58, value = "id")
	private String id;
