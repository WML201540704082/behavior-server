...
package com.lnsoft.ipc.demo.launcher;
...
public class DemoLauncherServiceImpl implements LauncherService {
	...
	public void launcher(SpringApplicationBuilder builder, String appName, String profile) {
		...
		PropsUtil.setProperty(props, "spring.cloud.nacos.config.ext-config[0].data-id", NacosConstant.dataId("idevelop-demo", profile));
