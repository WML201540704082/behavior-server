...
//	 * 代码所在服务名
//	 */
//	public static String SERVICE_NAME = "idevelop-system";
//	/**
//	 * 代码生成的包名
//	 */
//	public static String PACKAGE_NAME = "com.lnsoft.system";
//	/**
//	 * 前端代码生成所属系统
//	 */
...
//	 * 前端代码生成地址
//	 */
//	public static String PACKAGE_WEB_DIR = "/Users/guozhao/Workspaces/product/Sword";
//	/**
//	 * 需要去掉的表前缀
//	 */
//	public static String[] TABLE_PREFIX = {"idevelop_"};
//	/**
//	 * 需要生成的表名(两者只能取其一)
//	 */
//	public static String[] INCLUDE_TABLES = {"idevelop_tenant"};
//	/**
//	 * 需要排除的表名(两者只能取其一)
//	 */
